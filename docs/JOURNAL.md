...
|---|---|---|---|---|
| 25/09/2026 | 0.6.4 | <Nom, prénom> | Fonctionnel | Issue #9 — EF9 consultation du résultat : note et commentaire visibles par l'auteur, identité du relecteur jamais exposée (RG6), 404 avant rendu, 403 pour un non-auteur. |
