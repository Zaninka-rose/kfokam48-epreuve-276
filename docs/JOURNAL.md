...
|---|---|---|---|---|
| 25/09/2026 | 0.6.3 | <Nom, prénom> | Fonctionnel | Issue #8 — EF8 envoi de la relecture : 200 avec note/commentaire, note entière 0–20 (RG7), refus 403 de l'auteur (RG4), 409 RELECTURE_DEJA_RENDUE définitive (RG8). L'assignation est mutée en relecture rendue (contrainte d'unicité respectée) et la réponse suit le schéma Resultat du contrat. |
