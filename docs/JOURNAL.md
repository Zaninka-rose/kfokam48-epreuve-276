...
|---|---|---|---|---|
| 25/09/2026 | 0.6.5 | <Nom, prénom> | Fonctionnel | Issue #10 — EF10 tableau de bord formateur : présences par étudiant, exercice déposé avec statut, moyenne quand relue, relectures en attente (RG9), relecteurId visible du formateur seul (RG6), 404 si session inconnue. |
