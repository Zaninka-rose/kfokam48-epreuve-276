...
|---|---|---|---|---|
| 25/09/2026 | 0.6.6 | <Nom, prénom> | Fonctionnel | Issue #11 — EF12 clôture de session : 200 + marque session clôturée, dépôt et présence refusés (409 SESSION_CLOTUREE, RG10) ; vérifié aussi que le dépôt reste possible après simple expiration du code (§7). |
